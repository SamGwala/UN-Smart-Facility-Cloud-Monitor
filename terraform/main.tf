provider "aws" {
  region = "eu-north-1" #stockhol,=m
}

# 1. EC2 Instance
resource "aws_instance" "smart_cloud_monitor" {
  ami           = "ami-080254318c2d8932f" # Ubuntu 24.04 ID
...
resource "aws_cloudwatch_metric_alarm" "cpu_alarm" {
  ...
  # NEW: Added a second action - REBOOT. This is your "Day 5 Automation."
  alarm_actions       = [
...
# --- THE THREE SIMPLE ADDITIONS YOU CAN EASILY EXPLAIN ---

# A. IAM Role (Why? To give the EC2 permission to be managed by AWS)
...
# B. Budget (Why? To make sure you don't spend more than $5)
